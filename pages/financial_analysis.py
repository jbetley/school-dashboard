...
def update_financial_analysis_page(school: str, year: str, radio_value: str):
    ...
    if selected_school["Guest"].values[0] == "Y":
        ...
        financial_analysis_notes_string = (
            "Only the most recent years of audited data are shown."
        )
    ...
    if len(financial_data.columns) <= 1 or financial_data.empty:
        ...
        if len(financial_data.columns) <= 1:
            ...
            if (
                ...
                and (len(financial_ratios_data.index) != 0)
                and not set(ratio_years).isdisjoint(default_headers)
            ):
                ...
                financial_ratios_table = [
                    ...
                    html.P(""),
                    html.P(
                        "Source: IDOE Form 9 (hover over category for details).",
                        style={
                            "color": "#6783a9",
                            "fontSize": 10,
                            "marginLeft": "10px",
                                ...
                                [
                                    html.Div(
                                        [
                                            ...
                                            html.P(""),
                                            html.P(
                                                id="financial-analysis-notes-string",
                                                style={
                                                    "textAlign": "center",
                                                    "color": "#6783a9",
                                                    "fontSize": 12,
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            html.Div(
                                                [
                                                    html.Label(
                                                        id="finance-analysis-FA-title",
                                                        className="label__header",
                                                    ),
                                                    html.P(""),
                                                    html.Div(
                                                        id="financial-activities-table"
                                                    ),
                                                ],
                                                className="pretty-container six columns",
                                            ),
