    ...
    if radio_value == 'proficiency':
        ...
        if (selected_school_type == 'K8' or selected_school_type == 'K12'):
            ...
            if len(selected_raw_k8_school_data.index) > 0:
                ...
                all_k8_school_data = process_k8_academic_data(selected_raw_k8_school_data, year, school)
...
# TODO: At the very least clean this up - see load_data.py
                ...
                #raw_k8_school_data[~raw_k8_school_data["Year"].isin(excluded_years)]
