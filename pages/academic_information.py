...
def update_academic_information_page(school: str, year: str, radio_value:str):
    ...
    if radio_value == 'proficiency':
        ...
        if (selected_school_type == 'K8' or selected_school_type == 'K12'):
            ...
            if len(raw_k8_school_data.index) > 0:
                ...
                if selected_school_type == 'K8' and not (selected_school_id == 5874 and int(year) < 2021):
...
# TODO: At the very least clean this up - see load_data.py
                ...
                # all_k8_school_data = pd.DataFrame()           # NEED? 
        ...
        if (selected_school_type == 'HS' or selected_school_type == 'AHS' or selected_school_type == 'K12'
            or (selected_school_id == 5874 and int(year) < 2021)):

            # load HS academic data
            raw_hs_school_data = get_high_school_academic_data(school)
            
            if len(raw_hs_school_data.index) > 0:
                ...
                # if HS or AHS, hide K8 tables # TODO: ALready hidden?
        ...
        # # TODO: Shouldnt need this. Just build empty variables through each type check
