...
##############################################
# version:  1.16 (https://github.com/jbetley)
# date:     03/25/24
...
def update_organizational_compliance(school, year):
    ...
    org_compliance_definitions_table_dict = [
        dict(zip(org_compliance_definitions_table_keys, l))
        for l in org_compliance_definitions_data
    ]
    ...
    org_compliance_definitions_table = [
        dash_table.DataTable(
            ...
            columns=[
                {"name": i, "id": i} for i in org_compliance_definitions_table_keys
            ],
            style_data={
                "fontSize": "12px",
                "border": "none",
            ...
            style_data_conditional=[
                ...
                {
                    "if": {"row_index": 0, "column_id": "Standard"},
